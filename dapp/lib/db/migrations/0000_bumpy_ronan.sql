CREATE TABLE "dao_liquidity_pool" (
	...
	"pool_owner" varchar(42) NOT NULL,
	"dao_token_address" varchar(42) NOT NULL,
	"dao_token_name" varchar(256) NOT NULL,
	"dao_token_symbol" varchar(256) NOT NULL,
	"dao_token_decimals" integer NOT NULL,
	"liquidity_token_address" varchar(42) NOT NULL,
	"liquidity_token_name" varchar(256) NOT NULL,
	"liquidity_token_symbol" varchar(256) NOT NULL,
	"liquidity_token_decimals" integer NOT NULL,
